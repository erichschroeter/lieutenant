...
from entries.views import EntryList, EntryCreate, EntryRead, EntryUpdate, EntryDelete, EntryClone
from entries.models import Entry

urlpatterns = patterns('',
    url(r'^$', EntryList.as_view(), name='index'),
    url(r'^create/$', EntryCreate.as_view(success_url="/entries/"), name='create'),
    url(r'^clone/(?P<slug>[^/]+)/$', EntryClone.as_view(success_url="/entries/"), name='clone'),
